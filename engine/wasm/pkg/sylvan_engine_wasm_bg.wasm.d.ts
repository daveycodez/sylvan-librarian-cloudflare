...
export const fuzzy_card_by_name: (a: number, b: number, c: number, d: number, e: number, f: number, g: number, h: number, i: number) => [number, number, number, number];
...
export const load_printed_names: (a: number, b: number) => [number, number, number];
export const printed_names_heap_bytes: () => number;
export const printed_names_partitions: (a: number, b: number) => [number, number, number, number];
export const store_printed_records_tsv: () => [number, number, number, number];
export const store_name_records_tsv: () => [number, number, number, number];
...
export const named_fuzzy_bundle: (a: number, b: number, c: number, d: number, e: number, f: number, g: number, h: number, i: number, j: number, k: number, l: number, m: number) => [number, number, number, number];
