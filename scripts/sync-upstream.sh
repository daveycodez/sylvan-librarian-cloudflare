...
api/scryfall_compat/query_terms.py	src/routes/scryfall-compat/query-terms.ts (TS port; the ignore-and-warn policy tables ARE measurements — re-measure, do not merge)
