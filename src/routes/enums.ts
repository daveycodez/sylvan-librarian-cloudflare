 ...
 * flavor name, six tiers — borderless, then extended art (above full art and every other
 ...
 * white 7ed/121), any other set above a Secret Lair (Terror of the Peaks answers the Spotlight
 * Series pspl/1 over sld/2650), a real scan above a placeholder or low-resolution image, then
