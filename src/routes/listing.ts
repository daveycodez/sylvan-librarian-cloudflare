...
export const LISTINGS = {
	...
	search: {
        ...
        Args:
            ...
            prefer: Prefer order (oldest, newest, usd_low, usd_high, eur_low, eur_high, tix_low, tix_high, promo, default_frame, atypical, universesbeyond, notuniversesbeyond, borderless).
