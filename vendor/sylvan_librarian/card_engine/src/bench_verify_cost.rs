...
fn bench_verify_cost_clusters() {
    ...
    artist.bind(&data.coll_vocab, &data.coll_vocab_sorted, &data.artist_vocab, &data.artist_vocab_collated, &data.artist_entities, &data.mana_vocab, &data.indexes.flavor, &data.strings);
    ...
    flavor.bind(&data.coll_vocab, &data.coll_vocab_sorted, &data.artist_vocab, &data.artist_vocab_collated, &data.artist_entities, &data.mana_vocab, &data.indexes.flavor, &data.strings);
    ...
    coll.bind(&data.coll_vocab, &data.coll_vocab_sorted, &data.artist_vocab, &data.artist_vocab_collated, &data.artist_entities, &data.mana_vocab, &data.indexes.flavor, &data.strings);
    ...
    let anchored_ns = run(
        ...
        &FilterExpr::TextRegex { field: TextField::OracleTextLower, regex: CompiledRegex::new("^flying$").unwrap() },
    );
    let bare_ns = run(
    ...
    let machinery_ns = run(
        ...
        &FilterExpr::TextRegex { field: TextField::OracleTextLower, regex: CompiledRegex::new("draw .* cards?").unwrap() },
    );
    let machinery_noprefix_ns = run(
        "TextRegex (machinery, no prefix)",
        &FilterExpr::TextRegex { field: TextField::OracleTextLower, regex: CompiledRegex::new("^[aeiou]").unwrap() },
    );
...
fn bench_price_and_range_verify_cost() {
    ...
    usd.bind(&data.coll_vocab, &data.coll_vocab_sorted, &data.artist_vocab, &data.artist_vocab_collated, &data.artist_entities, &data.mana_vocab, &data.indexes.flavor, &data.strings);
